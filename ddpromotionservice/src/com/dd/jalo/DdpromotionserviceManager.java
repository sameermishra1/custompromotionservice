...
import com.dd.constants.DdpromotionserviceConstants;



/**
 * This is the extension manager of the Ddpromotionservice extension.
 */
public class DdpromotionserviceManager extends GeneratedDdpromotionserviceManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(DdpromotionserviceManager.class);
	 ...
	 */
	public static DdpromotionserviceManager getInstance()
	{
		return (DdpromotionserviceManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(DdpromotionserviceConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public DdpromotionserviceManager() // NOPMD 
	{
		LOG.debug("constructor of DdpromotionserviceManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of DdpromotionserviceManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of DdpromotionserviceManager called, current tenant: {}", getTenant().getTenantID());
	}
